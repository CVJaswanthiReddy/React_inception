...
// src/constants.js
const REACT_MEDIA_ASSETS_BASE_URL = "https://media-assets.swiggy.com/swiggy/";

export const ITEM_IMG_CDN_URL = `${REACT_MEDIA_ASSETS_BASE_URL}image/upload/fl_lossy,f_auto,q_auto,w_208,h_208,c_fit/`;
